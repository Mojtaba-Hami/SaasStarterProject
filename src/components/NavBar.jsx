            ...
            {isMenuShown ? (
              ...
              >
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  class="lucide lucide-x size-5 text-muted-foreground"
                >
              ...
              >
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  class="lucide lucide-menu size-5 text-muted-foreground"
                >
      ...
      {isMenuShown && (
        <div className="bg-black z-20 w-full h-screen fixed ">
          <ul className="md:hidden flex flex-col px-5 py-5 gap-3 font-semibold text-white ">
            <Link
              onClick={() => setIsMenuShown(false)}
              className={`hover:text-gray-300 border-b-[0.1px] border-gray-500 ${
                pathName === "/pricing" ? "text-white" : ""
              }  opacity-60 pb-3 `}
              href="/pricing"
            >
            ...
            <Link
              onClick={() => setIsMenuShown(false)}
              className={`hover:text-gray-300 opacity-60 ${
