      ...
      <div className="flex gap-2 items-center font-medium">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-5 '>
            <div className='border border-neutral-800 p-5 rounded-xl flex flex-col gap-3'>
                <p className='font-semibold text-xl'>Using NextAuth.js with Next.14</p>
                <p className='text-neutral-400'>How to use Auth.js v5 in server components.</p>
                <p className='text-neutral-400'>November 23, 2022</p>
            </div>
            <div>
                <div className='border border-neutral-800 p-5 rounded-xl flex flex-col gap-3'>
                <p className='font-semibold text-xl'>Build a blog using ContentLayer and MDX.</p>
                <p className='text-neutral-400'>Learn how to use ContentLayer to build a blog with Next.js</p>
